...
export const getUserById = async (req, res) => {
  try {
    ...
    return res.status(500).send({message: "Erro ao buscar o ID usuários!", error: error.message });
  }
};
...
export const createUser = async (req, res) => {
  ...
  try {
    ...
    return res.status(500).send({message: "Erro ao criar usuários!", error: error.message });
  }
};
